...
OAUTH_TOKEN = os.getenv("OAUTH_TOKEN")         # OAuth-токен (legacy, для старых сервисов)
YANDEX_API_KEY = os.getenv("YANDEX_API_KEY")   # Yandex Cloud API-key для Images API (aliceai-image-art-3.0)
