...
#        "Используй светлые тона. "
        "Сгенерируй 10 различных жизнеутверждающих тем для создания иллюстраций, со своей техникой рисования."
...
#        "Если сегодня 6 число, то пусть рисунок будет состоять из всех 10 тем. "
        f"Выведи только одну выбранную тему. Не нужно выводит список тем и результат расчета. В ней должны быть:\n"
#        "Короткий заголовок "
        "Точка зрения. "
        "Краткое описание (3–6 предложения и два действия) "
        ...
        "Включить хотя бы один неожиданный элемент, чтобы сделать изображение более интригующим. "
